...
alphatab.platform.svg.SvgCanvas.prototype = {
  ...
  ,toSvg: function(includeWrapper,className) {
    ...
    if(includeWrapper) {
      ...
      if(className != null) {
        buf.b += " class=\"";
        if(className == null) buf.b += "null"; else buf.b += "" + className;
        buf.b += "\"";
      }
      buf.b += ">\n";
    }
...
alphatab.platform.model.TextAlign.__empty_constructs__ = [alphatab.platform.model.TextAlign.Left,alphatab.platform.model.TextAlign.Center,alphatab.platform.model.TextAlign.Right];
alphatab.model = {};
...
alphatab.model.TextBaseline.__empty_constructs__ = [alphatab.model.TextBaseline.Default,alphatab.model.TextBaseline.Top,alphatab.model.TextBaseline.Middle,alphatab.model.TextBaseline.Bottom];
...
alphatab.platform.js.JsFileLoader.prototype = {
  loadBinary: function(path) {
    ...
    if(ie >= 0 && ie <= 9) {
      ...
      xhr.send(null);
      if(xhr.status == 200) {
        var reader1 = alphatab.platform.js.JsFileLoader.getBytesFromTyped(xhr.response);
        return reader1;
...
alphatab.rendering.effects.DynamicsEffectInfo.prototype = {
  ...
  ,shouldCreateGlyph: function(renderer,beat) {
    return beat.voice.index == 0 && (beat.index == 0 && beat.voice.bar.index == 0 || beat.previousBeat != null && beat.dynamicValue != beat.previousBeat.dynamicValue);
  }
  ,canExpand: function(renderer,from,to) {
    return true;
  }
...
alphatab.rendering.utils.BeamDirection.__empty_constructs__ = [alphatab.rendering.utils.BeamDirection.Up,alphatab.rendering.utils.BeamDirection.Down];
...
alphatab.rendering.RhythmBarRendererFactory.__name__ = true;
alphatab.rendering.RhythmBarRendererFactory.__super__ = alphatab.rendering.BarRendererFactory;
alphatab.rendering.RhythmBarRendererFactory.prototype = $extend(alphatab.rendering.BarRendererFactory.prototype,{
  create: function(bar) {
    return new alphatab.rendering.RhythmBarRenderer(bar,this._direction);
  }
  ,__class__: alphatab.rendering.RhythmBarRendererFactory
});
...
alphatab.Settings.fromJson = function(json) {
  ...
  if(alphatab.Settings.jsonExists(json,"layout")) {
    if(typeof(json.layout) == "string") settings.layout.mode = json.layout; else {
  ...
  if(alphatab.Settings.jsonExists(json,"staves")) {
    settings.staves = new Array();
    var _g2 = 0;
    var _g11 = Reflect.fields(json.staves);
    while(_g2 < _g11.length) {
      var key1 = _g11[_g2];
      ++_g2;
      var val = Reflect.field(json.staves,key1);
      if(typeof(val) == "string") settings.staves.push(new alphatab.StaveSettings(val)); else if(val.id) {
        ...
        if(val.additionalSettings) {
          ...
          while(_g21 < _g3.length) {
            var key2 = _g3[_g21];
            ++_g21;
            staveSettings.additionalSettings.set(key2,Reflect.field(val.additionalSettings,key2));
          }
        }
      }
    }
...
alphatab.audio.generator.MidiFileGenerator.toChannelShort = function(data) {
  var value = Std["int"](Math.max(-32768,Math.min(32767,data * 8 - 1)));
  ...
  ,getBrushInfo: function(beat) {
    ...
    if(beat.brushType != alphatab.model.BrushType.None) {
      ...
      if(beat.notes.length > 0) {
        ...
        var _g12 = 0;
        var _g3 = beat.voice.bar.track.tuning.length;
        while(_g12 < _g3) {
          var i1 = _g12++;
          var index;
          if(beat.brushType == alphatab.model.BrushType.ArpeggioDown || beat.brushType == alphatab.model.BrushType.BrushDown) index = i1; else index = brushInfo.length - 1 - i1;
...
alphatab.audio.generator.MidiPlaybackController.prototype = {
  ...
  ,process: function() {
    ...
    this._lastIndex = Std["int"](Math.max(this._lastIndex,this.index));
  ...
  addEvent: function(event) {
    ...
    if(this.firstEvent == null) {
      ...
      if(firstDelta < lastDelta) {
        ...
        while(next1 != null && next1.previousEvent != null && next1.previousEvent.tick > event.tick) next1 = next1.previousEvent;
        ...
        if(previous1 != null) previous1.nextEvent = event; else this.firstEvent = event;
      }
    }
  }
  ,writeTo: function(out) {
...
alphatab.importer.AlphaTexImporter.prototype = $extend(alphatab.importer.ScoreImporter.prototype,{
    ...
    while(this._sy == alphatab.importer.AlphaTexSymbols.String) {
      ...
      if(this._syData == "b") {
        ...
        while(this._sy != alphatab.importer.AlphaTexSymbols.RParensis && this._sy != alphatab.importer.AlphaTexSymbols.Eof) {
          ...
          note.bendPoints.push(new alphatab.model.BendPoint(0,Std["int"](Math.abs(bendValue))));
          this.newSy();
        }
        ...
        this.newSy();
        var duration1 = alphatab.model.Duration.Eighth;
        if(this._sy == alphatab.importer.AlphaTexSymbols.Number) {
          var _g1 = this._syData;
          switch(_g1) {
          case 8:
            duration1 = alphatab.model.Duration.Eighth;
            break;
          case 16:
            duration1 = alphatab.model.Duration.Sixteenth;
            break;
          case 32:
            duration1 = alphatab.model.Duration.ThirtySecond;
            break;
          default:
            duration1 = alphatab.model.Duration.Eighth;
          }
  ...
  ,newSy: function() {
    ...
    do if(this._ch == alphatab.importer.AlphaTexImporter.Eof) this._sy = alphatab.importer.AlphaTexSymbols.Eof; else if(this._ch == " " || this._ch == "\n" || this._ch == "\r" || this._ch == "\t") this.nextChar(); else if(this._ch == "/") {
      ...
      if(alphatab.model.Tuning.isTuning(name1)) {
...
alphatab.importer.AlphaTexSymbols.__empty_constructs__ = [alphatab.importer.AlphaTexSymbols.No,alphatab.importer.AlphaTexSymbols.Eof,alphatab.importer.AlphaTexSymbols.Number,alphatab.importer.AlphaTexSymbols.DoubleDot,alphatab.importer.AlphaTexSymbols.Dot,alphatab.importer.AlphaTexSymbols.String,alphatab.importer.AlphaTexSymbols.Tuning,alphatab.importer.AlphaTexSymbols.LParensis,alphatab.importer.AlphaTexSymbols.RParensis,alphatab.importer.AlphaTexSymbols.LBrace,alphatab.importer.AlphaTexSymbols.RBrace,alphatab.importer.AlphaTexSymbols.Pipe,alphatab.importer.AlphaTexSymbols.MetaCommand,alphatab.importer.AlphaTexSymbols.Multiply];
...
alphatab.importer.Gp3To5Importer.prototype = $extend(alphatab.importer.ScoreImporter.prototype,{
    ...
    if(this._versionNumber >= 500) {
      ...
      if(this._versionNumber >= 400) {
        ...
        while(_g1 < 7) {
          ...
          if(i1 < chord.strings.length) chord.strings.push(fret1);
        }
        this._data.read(32);
      } else {
        this._data.read(25);
      ...
      if(chord.firstFret > 0) {
        ...
        while(_g3 < strings) {
          ...
          if(i3 < chord.strings.length) chord.strings.push(fret3);
        }
      }
    }
  ...
  ,readBeatEffects: function(beat) {
    ...
    if((flags & 32) != 0 && this._versionNumber >= 400) {
      ...
      var slapPop1 = this._data.readInt8();
      switch(slapPop1) {
      case 1:
        beat.tap = true;
        break;
    ...
    try {
      while(uncompressed.length < expectedLength) {
        ...
        if(flag == 1) {
          ...
          var toRead = Std["int"](Math.min(offset,size));
  ...
  ,readUncompressedBlock: function(data) {
    ...
    while(offset + 3 < data.length) {
      ...
      if(entryType == 2) {
        ...
        if(storeFile) {
          file.data = haxe.io.Bytes.alloc(Std["int"](Math.min(file.fileSize,fileData.length)));
      ...
      if(c.nodeType == Xml.Element) {
        ...
        case "Property":
          ...
          case "WhammyBarOriginValue":
            ...
            whammyOrigin.value = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.04);
            break;
          case "WhammyBarOriginOffset":
            if(whammyOrigin == null) whammyOrigin = new alphatab.model.BendPoint();
            whammyOrigin.offset = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.6);
            break;
          case "WhammyBarMiddleValue":
            whammyMiddleValue = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.04);
            break;
          case "WhammyBarMiddleOffset1":
            whammyMiddleOffset1 = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.6);
            break;
          case "WhammyBarMiddleOffset2":
            whammyMiddleOffset2 = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.6);
            break;
          case "WhammyBarDestinationValue":
            if(whammyDestination == null) whammyDestination = new alphatab.model.BendPoint(60);
            whammyDestination.value = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.04);
            break;
          case "WhammyBarDestinationOffset":
            if(whammyDestination == null) whammyDestination = new alphatab.model.BendPoint();
            whammyDestination.offset = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.6);
            break;
          }
          break;
        }
      ...
      if(c.nodeType == Xml.Element) {
        ...
        case "Property":
          ...
          case "BendOriginValue":
            ...
            bendOrigin.value = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.04);
            break;
          case "BendOriginOffset":
            if(bendOrigin == null) bendOrigin = new alphatab.model.BendPoint();
            bendOrigin.offset = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.6);
            break;
          case "BendMiddleValue":
            bendMiddleValue = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.04);
            break;
          case "BendMiddleOffset1":
            bendMiddleOffset1 = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.6);
            break;
          case "BendMiddleOffset2":
            bendMiddleOffset2 = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.6);
            break;
          case "BendDestinationValue":
            if(bendDestination == null) bendDestination = new alphatab.model.BendPoint(60);
            bendDestination.value = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.04);
            break;
          case "BendDestinationOffset":
            if(bendDestination == null) bendDestination = new alphatab.model.BendPoint();
            bendDestination.offset = Std["int"](Std.parseFloat(this.getValue(this.findChildElement(c,"Float"))) * 0.6);
            break;
          case "HopoOrigin":
  ...
  ,buildModel: function() {
    ...
    while( $it1.hasNext() ) {
      ...
      if(this._beatsOfVoice.exists(voiceId)) {
        var _g2 = 0;
        var _g11 = this._beatsOfVoice.get(voiceId);
        while(_g2 < _g11.length) {
          var beatId1 = _g11[_g2];
          ++_g2;
          if(beatId1 != "-1") voice.addBeat(this._beatById.get(beatId1).clone());
        }
      }
    }
    ...
    while( $it2.hasNext() ) {
      ...
      if(this._voicesOfBar.exists(barId)) {
        var _g3 = 0;
        var _g12 = this._voicesOfBar.get(barId);
        while(_g3 < _g12.length) {
          var voiceId1 = _g12[_g3];
          ++_g3;
          if(voiceId1 != "-1") bar.addVoice(this._voiceById.get(voiceId1)); else {
            var voice1 = new alphatab.model.Voice();
            bar.addVoice(voice1);
            var beat1 = new alphatab.model.Beat();
            beat1.isEmpty = true;
            beat1.duration = alphatab.model.Duration.Quarter;
    ...
    var trackIndex = 0;
    var _g4 = 0;
    var _g13 = this._tracksMapping;
    while(_g4 < _g13.length) {
      var trackId = _g13[_g4];
      ++_g4;
      var track = this._tracksById.get(trackId);
      this.score.addTrack(track);
      var _g21 = 0;
      var _g31 = this._barsOfMasterBar;
      while(_g21 < _g31.length) {
        var barIds = _g31[_g21];
        ++_g21;
        var barId1 = barIds[trackIndex];
        if(barId1 != "-1") track.addBar(this._barsById.get(barId1));
      }
      trackIndex++;
    }
    ...
    while( $it3.hasNext() ) {
      var barId2 = $it3.next();
      var bar1 = this._barsById.get(barId2);
      var _g5 = 0;
      var _g14 = bar1.voices;
      while(_g5 < _g14.length) {
        var v = _g14[_g5];
        ++_g5;
        if(v.beats.length > 0) {
          var _g22 = 0;
          var _g32 = this._automations.get(barId2);
          while(_g22 < _g32.length) {
            var automation = _g32[_g22];
            ++_g22;
    ...
    var _g6 = 0;
    var _g15 = this._masterBars;
    while(_g6 < _g15.length) {
      var masterBar = _g15[_g6];
      ++_g6;
    ...
    while( $it4.hasNext() ) {
      var barId3 = $it4.next();
      var automations = this._automations.get(barId3);
      var bar2 = this._barsById.get(barId3);
      var _g7 = 0;
      while(_g7 < automations.length) {
        var automation1 = automations[_g7];
        ++_g7;
        if(automation1.type == alphatab.model.AutomationType.Tempo) {
          if(barId3 == "0") {
            this.score.tempo = automation1.value | 0;
            this.score.tempoLabel = automation1.text;
          }
          bar2.track.score.masterBars[bar2.index].tempoAutomation = automation1;
        }
      }
    }
  }
...
alphatab.io.BytesArray.prototype = {
  ...
  ,add: function(v) {
    ...
    this._data.set(this.length++,v & 255);
  }
  ,addBytes: function(v) {
    if(v.length > 0) {
  ...
  ,updateCapacity: function(min) {
    ...
    if(this._data.length < min) {
      var c = Std["int"](Math.max(this._data.length * 2,min));
      this.setCapacity(c);
    }
  }
...
alphatab.io.OutputExtensions.writeAsString = function(output,value) {
  var text;
  if(typeof(value) == "string") text = js.Boot.__cast(value , String); else text = Std.string(value);
...
alphatab.model.AccentuationType.__empty_constructs__ = [alphatab.model.AccentuationType.None,alphatab.model.AccentuationType.Normal,alphatab.model.AccentuationType.Heavy];
...
alphatab.model.AccidentalType.__empty_constructs__ = [alphatab.model.AccidentalType.None,alphatab.model.AccidentalType.Natural,alphatab.model.AccidentalType.Sharp,alphatab.model.AccidentalType.Flat];
...
alphatab.model.AutomationType.__empty_constructs__ = [alphatab.model.AutomationType.Tempo,alphatab.model.AutomationType.Volume,alphatab.model.AutomationType.Instrument,alphatab.model.AutomationType.Balance];
...
alphatab.model.Bar.prototype = {
  ...
  ,finish: function() {
    ...
    while(_g < _g1.length) {
      ...
      ++_g;
      v.finish();
      if(v.minDuration == null || this.minDuration == null || alphatab.model.ModelUtils.getDurationValue(this.minDuration) > alphatab.model.ModelUtils.getDurationValue(v.minDuration)) this.minDuration = v.minDuration;
      if(v.maxDuration == null || this.maxDuration == null || alphatab.model.ModelUtils.getDurationValue(this.maxDuration) < alphatab.model.ModelUtils.getDurationValue(v.maxDuration)) this.maxDuration = v.maxDuration;
    }
  }
...
alphatab.model.BrushType.__empty_constructs__ = [alphatab.model.BrushType.None,alphatab.model.BrushType.BrushUp,alphatab.model.BrushType.BrushDown,alphatab.model.BrushType.ArpeggioUp,alphatab.model.BrushType.ArpeggioDown];
...
alphatab.model.Clef.__empty_constructs__ = [alphatab.model.Clef.Neutral,alphatab.model.Clef.C3,alphatab.model.Clef.C4,alphatab.model.Clef.F4,alphatab.model.Clef.G2];
...
alphatab.model.Duration.__empty_constructs__ = [alphatab.model.Duration.Whole,alphatab.model.Duration.Half,alphatab.model.Duration.Quarter,alphatab.model.Duration.Eighth,alphatab.model.Duration.Sixteenth,alphatab.model.Duration.ThirtySecond,alphatab.model.Duration.SixtyFourth];
...
alphatab.model.DynamicValue.__empty_constructs__ = [alphatab.model.DynamicValue.PPP,alphatab.model.DynamicValue.PP,alphatab.model.DynamicValue.P,alphatab.model.DynamicValue.MP,alphatab.model.DynamicValue.MF,alphatab.model.DynamicValue.F,alphatab.model.DynamicValue.FF,alphatab.model.DynamicValue.FFF];
...
alphatab.model.GraceType.__empty_constructs__ = [alphatab.model.GraceType.None,alphatab.model.GraceType.OnBeat,alphatab.model.GraceType.BeforeBeat];
...
alphatab.model.HarmonicType.__empty_constructs__ = [alphatab.model.HarmonicType.None,alphatab.model.HarmonicType.Natural,alphatab.model.HarmonicType.Artificial,alphatab.model.HarmonicType.Pinch,alphatab.model.HarmonicType.Tap,alphatab.model.HarmonicType.Semi,alphatab.model.HarmonicType.Feedback];
...
alphatab.model.Note.prototype = {
  ...
  ,finish: function() {
    var _g = this;
    var nextNoteOnLine = new alphatab.util.LazyVar(function() {
      return alphatab.model.Note.nextNoteOnSameLine(_g);
    });
    var prevNoteOnLine = new alphatab.util.LazyVar(function() {
      return alphatab.model.Note.previousNoteOnSameLine(_g);
    });
    if(this.isTieDestination) {
      if(prevNoteOnLine.getValue() == null) this.isTieDestination = false; else {
        this.tieOrigin = prevNoteOnLine.getValue();
        this.tieOrigin.isTieOrigin = true;
        this.fret = this.tieOrigin.fret;
      }
    }
    if(this.isHammerPullOrigin) {
      if(nextNoteOnLine.getValue() == null) this.isHammerPullOrigin = false; else {
        nextNoteOnLine.getValue().isHammerPullDestination = true;
        nextNoteOnLine.getValue().hammerPullOrigin = this;
      }
    }
    if(this.slideType != alphatab.model.SlideType.None) this.slideTarget = nextNoteOnLine.getValue();
  }
...
alphatab.model.PickStrokeType.__empty_constructs__ = [alphatab.model.PickStrokeType.None,alphatab.model.PickStrokeType.Up,alphatab.model.PickStrokeType.Down];
...
alphatab.model.SlideType.__empty_constructs__ = [alphatab.model.SlideType.None,alphatab.model.SlideType.Shift,alphatab.model.SlideType.Legato,alphatab.model.SlideType.IntoFromBelow,alphatab.model.SlideType.IntoFromAbove,alphatab.model.SlideType.OutUp,alphatab.model.SlideType.OutDown];
...
alphatab.model.TripletFeel.__empty_constructs__ = [alphatab.model.TripletFeel.NoTripletFeel,alphatab.model.TripletFeel.Triplet16th,alphatab.model.TripletFeel.Triplet8th,alphatab.model.TripletFeel.Dotted16th,alphatab.model.TripletFeel.Dotted8th,alphatab.model.TripletFeel.Scottish16th,alphatab.model.TripletFeel.Scottish8th];
...
alphatab.model.Tuning.getTextForTuning = function(tuning,includeOctave) {
  ...
  if(includeOctave) if(octave == null) result += "null"; else result += "" + octave;
  return result;
};
...
alphatab.model.VibratoType.__empty_constructs__ = [alphatab.model.VibratoType.None,alphatab.model.VibratoType.Slight,alphatab.model.VibratoType.Wide];
...
alphatab.model.Voice.prototype = {
  ...
  ,finish: function() {
    ...
    while(_g < _g1.length) {
      ...
      ++_g;
      b.finish();
      if(this.minDuration == null || alphatab.model.ModelUtils.getDurationValue(this.minDuration) > alphatab.model.ModelUtils.getDurationValue(b.duration)) this.minDuration = b.duration;
      if(this.maxDuration == null || alphatab.model.ModelUtils.getDurationValue(this.maxDuration) < alphatab.model.ModelUtils.getDurationValue(b.duration)) this.maxDuration = b.duration;
    }
  }
...
alphatab.platform.svg.FontSizes.measureString = function(s,f,size) {
  ...
  while(_g1 < _g) {
    var i = _g1++;
    var code = Std["int"](Math.min(data.length - 1,HxOverrides.cca(s,i))) - alphatab.platform.svg.FontSizes.ControlChars;
    if(code >= 0) {
...
alphatab.platform.svg.SupportedFonts.__empty_constructs__ = [alphatab.platform.svg.SupportedFonts.TimesNewRoman,alphatab.platform.svg.SupportedFonts.Arial];
...
alphatab.rendering.AlternateEndingsBarRenderer.prototype = $extend(alphatab.rendering.BarRendererBase.prototype,{
  ...
  ,doLayout: function() {
    ...
    this.height = Std["int"](this.stave.staveGroup.layout.renderer.renderingResources.wordsFont.getSize());
...
alphatab.rendering.EffectBarGlyphSizing.__empty_constructs__ = [alphatab.rendering.EffectBarGlyphSizing.SinglePreBeatOnly,alphatab.rendering.EffectBarGlyphSizing.SinglePreBeatToOnBeat,alphatab.rendering.EffectBarGlyphSizing.SinglePreBeatToPostBeat,alphatab.rendering.EffectBarGlyphSizing.SingleOnBeatOnly,alphatab.rendering.EffectBarGlyphSizing.SingleOnBeatToPostBeat,alphatab.rendering.EffectBarGlyphSizing.SinglePostBeatOnly,alphatab.rendering.EffectBarGlyphSizing.GroupedPreBeatOnly,alphatab.rendering.EffectBarGlyphSizing.GroupedPreBeatToOnBeat,alphatab.rendering.EffectBarGlyphSizing.GroupedPreBeatToPostBeat,alphatab.rendering.EffectBarGlyphSizing.GroupedOnBeatOnly,alphatab.rendering.EffectBarGlyphSizing.GroupedOnBeatToPostBeat,alphatab.rendering.EffectBarGlyphSizing.GroupedPostBeatOnly];
...
alphatab.rendering.GroupedBarRenderer.prototype = $extend(alphatab.rendering.BarRendererBase.prototype,{
  ...
  ,applySizes: function(sizes) {
    ...
    if(postSizeDiff > 0) {
      ...
      var _g11 = 0;
      var _g2 = this._postBeatGlyphs.length;
      while(_g11 < _g2) {
        var i = _g11++;
  ...
  ,paint: function(cx,cy,canvas) {
    ...
    var _g2 = 0;
    var _g11 = this._voiceContainers;
    while(_g2 < _g11.length) {
      var c = _g11[_g2];
      ++_g2;
  ...
  ,alignGlyph: function(sizing,beatIndex,voiceIndex,prevGlyph) {
    ...
    case 7:
      if(g != prevGlyph) this.alignGlyph(alphatab.rendering.EffectBarGlyphSizing.SinglePreBeatToOnBeat,beatIndex,voiceIndex,prevGlyph); else {
        pos = container.onNotes;
        var posR1;
        posR1 = js.Boot.__cast(pos.renderer , alphatab.rendering.EffectBarRenderer);
        var gR1;
        gR1 = js.Boot.__cast(g.renderer , alphatab.rendering.EffectBarRenderer);
    ...
    case 8:
      if(g != prevGlyph) this.alignGlyph(alphatab.rendering.EffectBarGlyphSizing.SinglePreBeatToPostBeat,beatIndex,voiceIndex,prevGlyph); else {
        pos = container.postNotes;
        var posR2;
        posR2 = js.Boot.__cast(pos.renderer , alphatab.rendering.EffectBarRenderer);
        var gR2;
        gR2 = js.Boot.__cast(g.renderer , alphatab.rendering.EffectBarRenderer);
    ...
    case 9:
      if(g != prevGlyph) this.alignGlyph(alphatab.rendering.EffectBarGlyphSizing.SingleOnBeatOnly,beatIndex,voiceIndex,prevGlyph); else {
        pos = container.onNotes;
        var posR3;
        posR3 = js.Boot.__cast(pos.renderer , alphatab.rendering.EffectBarRenderer);
        var gR3;
        gR3 = js.Boot.__cast(g.renderer , alphatab.rendering.EffectBarRenderer);
    ...
    case 10:
      if(g != prevGlyph) this.alignGlyph(alphatab.rendering.EffectBarGlyphSizing.SingleOnBeatToPostBeat,beatIndex,voiceIndex,prevGlyph); else {
        pos = container.postNotes;
        var posR4;
        posR4 = js.Boot.__cast(pos.renderer , alphatab.rendering.EffectBarRenderer);
        var gR4;
        gR4 = js.Boot.__cast(g.renderer , alphatab.rendering.EffectBarRenderer);
    ...
    case 11:
      if(g != prevGlyph) this.alignGlyph(alphatab.rendering.EffectBarGlyphSizing.GroupedPostBeatOnly,beatIndex,voiceIndex,prevGlyph); else {
        pos = container.postNotes;
        var posR5;
        posR5 = js.Boot.__cast(pos.renderer , alphatab.rendering.EffectBarRenderer);
        var gR5;
        gR5 = js.Boot.__cast(g.renderer , alphatab.rendering.EffectBarRenderer);
...
alphatab.rendering.RhythmBarRenderer.__name__ = true;
...
alphatab.rendering.RhythmBarRenderer.__super__ = alphatab.rendering.GroupedBarRenderer;
alphatab.rendering.RhythmBarRenderer.prototype = $extend(alphatab.rendering.GroupedBarRenderer.prototype,{
  doLayout: function() {
    this._helpers = this.stave.staveGroup.helpers.helpers.get(this.bar.track.index).get(this.bar.index);
    alphatab.rendering.GroupedBarRenderer.prototype.doLayout.call(this);
    this.height = 24 * this.stave.staveGroup.layout.renderer.settings.scale | 0;
    this.isEmpty = false;
  }
  ,createBeatGlyphs: function() {
    this.createVoiceGlyphs(this.bar.voices[0]);
  ...
  ,paintBar: function(cx,cy,canvas,h) {
    ...
    while(_g1 < _g) {
      ...
      if(h._beatLineXPositions.exists(beat.index)) {
        var beatLineX = Std["int"](h.getBeatLineX(beat) + this.stave.staveGroup.layout.renderer.settings.scale);
        var y1 = cy + this.y;
        ...
        while(_g2 < barCount) {
          ...
          if(i < h.beats.length - 1) {
            if(this.isFullBarJoin(beat,h.beats[i + 1],barIndex)) {
              barStartX = beatLineX;
              barEndX = Std["int"](h.getBeatLineX(h.beats[i + 1]) + this.stave.staveGroup.layout.renderer.settings.scale);
  ...
  ,paintFooter: function(cx,cy,canvas,h) {
    ...
    var beamY;
    if(direction == alphatab.rendering.utils.BeamDirection.Down) beamY = bottomY; else beamY = topY;
    canvas.setColor(this.stave.staveGroup.layout.renderer.renderingResources.mainGlyphColor);
    canvas.beginPath();
    ...
    canvas.stroke();
    var gx = beatLineX | 0;
    var glyph = new alphatab.rendering.glyphs.BeamGlyph(gx,beamY,beat.duration,direction,false);
    glyph.renderer = this;
    glyph.doLayout();
  ...
  ,__class__: alphatab.rendering.RhythmBarRenderer
});
...
alphatab.rendering.ScoreBarRenderer.prototype = $extend(alphatab.rendering.GroupedBarRenderer.prototype,{
  ...
  ,doLayout: function() {
    ...
    while(_g < _g1.length) {
      ...
      while(_g2 < v.length) {
        ...
        if(maxNoteY < top) this.registerOverflowTop(Std["int"](Math.abs(maxNoteY)));
        ...
        if(minNoteY > bottom) this.registerOverflowBottom(Std["int"](Math.abs(minNoteY)) - bottom);
      }
    }
  }
  ,paint: function(cx,cy,canvas) {
  ...
  ,paintTupletHelper: function(cx,cy,canvas,h) {
    ...
    if(h.beats.length == 1 || !(h.beats.length == h.tuplet)) {
      ...
      while(_g1 < _g) {
        ...
        var tupletX = Std["int"](beamingHelper.getBeatLineX(beat) + this.stave.staveGroup.layout.renderer.settings.scale);
        var tupletY = cy + this.y + this.calculateBeamY(beamingHelper,tupletX);
        var offset;
        if(direction == alphatab.rendering.utils.BeamDirection.Up) offset = Std["int"](res.effectFont.getSize() * 1.8); else offset = -(3 * this.stave.staveGroup.layout.renderer.settings.scale | 0);
        canvas.setFont(res.effectFont);
        canvas.fillText(h.tuplet == null?"null":"" + h.tuplet,cx + this.x + tupletX,tupletY - offset);
      }
    } else {
      var firstBeat = h.beats[0];
      var lastBeat = h.beats[h.beats.length - 1];
      var beamingHelper1 = this._helpers.beamHelperLookup[h.voiceIndex].get(firstBeat.index);
      if(beamingHelper1 != null) {
        var direction1 = beamingHelper1.getDirection();
        var startX = Std["int"](beamingHelper1.getBeatLineX(firstBeat) + this.stave.staveGroup.layout.renderer.settings.scale);
        var endX = Std["int"](beamingHelper1.getBeatLineX(lastBeat) + this.stave.staveGroup.layout.renderer.settings.scale);
        canvas.setFont(res.effectFont);
        var s;
        if(h.tuplet == null) s = "null"; else s = "" + h.tuplet;
        ...
        var offset1 = 10 * this.stave.staveGroup.layout.renderer.settings.scale | 0;
        var size = 5 * this.stave.staveGroup.layout.renderer.settings.scale | 0;
        if(direction1 == alphatab.rendering.utils.BeamDirection.Down) {
          offset1 *= -1;
          size *= -1;
        }
        canvas.beginPath();
        ...
        canvas.stroke();
        canvas.fillText(s,cx + this.x + middleX,cy + this.y + middleY - offset1 - size - res.effectFont.getSize());
      }
    }
    ...
    while(_g1 < _g) {
      ...
      while(_g2 < barCount) {
        ...
        if(i < h.beats.length - 1) {
          ...
          barStartY = Std["int"](barY + this.calculateBeamY(h,barStartX));
          barEndY = Std["int"](barY + this.calculateBeamY(h,barEndX));
  ...
  ,createPreBeatGlyphs: function() {
    if(this.bar.getMasterBar().isRepeatStart) this.addPreBeatGlyph(new alphatab.rendering.glyphs.RepeatOpenGlyph(0,0,1.5,3));
  ...
  ,createPostBeatGlyphs: function() {
    if(this.bar.getMasterBar().isRepeatEnd()) {
    ...
    } else if(this.bar.getMasterBar().isDoubleBar) {
      ...
      this.addPostBeatGlyph(new alphatab.rendering.glyphs.BarSeperatorGlyph());
    } else if(this.bar.nextBar == null || !this.bar.nextBar.getMasterBar().isRepeatStart) this.addPostBeatGlyph(new alphatab.rendering.glyphs.BarSeperatorGlyph(0,0,this.bar.index == this.bar.track.bars.length - 1));
  }
  ...
  ,createKeySignatureGlyphs: function() {
    ...
    var previousKey;
    if(this.bar.previousBar == null) previousKey = 0; else previousKey = this.bar.previousBar.getMasterBar().keySignature;
    var _g = this.bar.clef;
    switch(_g[1]) {
    case 0:
      offsetClef = 0;
    ...
    var naturalizeSymbols = Std["int"](Math.abs(previousKey));
    ...
    while(_g1 < naturalizeSymbols) {
      var i = _g1++;
      this.addPreBeatGlyph(new alphatab.rendering.glyphs.NaturalizeGlyph(0,Std["int"](this.getScoreY(previousKeyPositions[i] + offsetClef))));
    }
    var offsetSymbols;
    if(currentKey <= 7) offsetSymbols = currentKey; else offsetSymbols = currentKey - 7;
    if(currentKey > 0) {
      var _g11 = 0;
      var _g2 = Std["int"](Math.abs(currentKey));
      while(_g11 < _g2) {
        var i1 = _g11++;
        this.addPreBeatGlyph(new alphatab.rendering.glyphs.SharpGlyph(0,Std["int"](this.getScoreY(alphatab.rendering.ScoreBarRenderer.SharpKsSteps[i1] + offsetClef))));
      }
    } else {
      var _g12 = 0;
      var _g3 = Std["int"](Math.abs(currentKey));
      while(_g12 < _g3) {
        var i2 = _g12++;
        this.addPreBeatGlyph(new alphatab.rendering.glyphs.FlatGlyph(0,Std["int"](this.getScoreY(alphatab.rendering.ScoreBarRenderer.FlatKsSteps[i2] + offsetClef))));
      }
    }
  }
  ,createTimeSignatureGlyphs: function() {
    ...
    this.addPreBeatGlyph(new alphatab.rendering.glyphs.TimeSignatureGlyph(0,0,this.bar.getMasterBar().timeSignatureNumerator,this.bar.getMasterBar().timeSignatureDenominator));
  }
  ,createVoiceGlyphs: function(v) {
    var _g = 0;
    var _g1 = v.beats;
  ...
  ,getNoteLine: function(n) {
    ...
    steps -= octave * 7;
    if(ks > 0 || ks == 0) steps -= alphatab.rendering.ScoreBarRenderer.SharpNoteSteps[index]; else steps -= alphatab.rendering.ScoreBarRenderer.FLAT_NOTE_STEPS[index];
    return steps + 1;
  }
...
alphatab.rendering.ScoreRenderer.prototype = {
  ...
  ,doLayout: function() {
    ...
    this.canvas.setHeight(Std["int"](this.layout.height + this.renderingResources.copyrightFont.getSize() * 2));
...
alphatab.rendering.TabBarRenderer.prototype = $extend(alphatab.rendering.GroupedBarRenderer.prototype,{
  ...
  ,createVoiceGlyphs: function(v) {
    ...
    while(_g < _g1.length) {
      ...
      (js.Boot.__cast(container.onNotes , alphatab.rendering.glyphs.TabBeatGlyph)).beamingHelper = this._helpers.beamHelperLookup[v.index].get(b.index);
  ...
  ,parseCommand: function(cx,cy,canvas,cmd) {
    ...
    case "S":
      ...
      while(i < cmd.numbers.length) {
        ...
        var x22;
        if(canContinue) x22 = this._currentX + (this._currentX - this._lastControlX); else x22 = this._currentX;
        var y22;
        if(canContinue) y22 = this._currentY + (this._currentY - this._lastControlY); else y22 = this._currentY;
    ...
    case "s":
      ...
      while(i < cmd.numbers.length) {
        ...
        canContinue = this._lastCmd == "c" || this._lastCmd == "C" || this._lastCmd == "S" || this._lastCmd == "s";
        var x23;
        if(canContinue) x23 = this._currentX + (this._currentX - this._lastControlX); else x23 = this._currentX;
        var y23;
        if(canContinue) y23 = this._currentY + (this._currentY - this._lastControlY); else y23 = this._currentY;
    ...
    case "t":
      ...
      while(i < cmd.numbers.length) {
        ...
        var cpx1 = this._currentX + (this._currentX - this._lastControlX);
        var cpy1 = this._currentY + (this._currentY - this._lastControlY);
        canContinue = this._lastCmd == "q" || this._lastCmd == "Q" || this._lastCmd == "t" || this._lastCmd == "T";
        var cpx2;
        if(canContinue) cpx2 = this._currentX + (this._currentX - this._lastControlX); else cpx2 = this._currentX;
        var cpy2;
        if(canContinue) cpy2 = this._currentY + (this._currentY - this._lastControlY); else cpy2 = this._currentY;
...
alphatab.rendering.glyphs.BendGlyph.prototype = $extend(alphatab.rendering.Glyph.prototype,{
  paint: function(cx,cy,canvas) {
    ...
    canvas.beginPath();
    var _g11 = 0;
    var _g2 = this._note.bendPoints.length - 1;
    while(_g11 < _g2) {
      var i1 = _g11++;
      var firstPt = this._note.bendPoints[i1];
      var secondPt = this._note.bendPoints[i1 + 1];
      if(firstPt.value == secondPt.value && i1 == this._note.bendPoints.length - 2) continue;
...
alphatab.rendering.glyphs.CrescendoType.__empty_constructs__ = [alphatab.rendering.glyphs.CrescendoType.None,alphatab.rendering.glyphs.CrescendoType.Crescendo,alphatab.rendering.glyphs.CrescendoType.Decrescendo];
...
alphatab.rendering.glyphs.DigitGlyph.prototype = $extend(alphatab.rendering.glyphs.SvgGlyph.prototype,{
  doLayout: function() {
    ...
    this.width = Std["int"](this.getDigitWidth(this._digit) * this.renderer.stave.staveGroup.layout.renderer.settings.scale);
  }
  ,canScale: function() {
    return false;
  }
...
alphatab.rendering.glyphs.NoteHeadGlyph.prototype = $extend(alphatab.rendering.glyphs.SvgGlyph.prototype,{
  doLayout: function() {
    ...
    switch(_g[1]) {
    case 0:
      this.width = 14 * (this._isGrace?0.7:1) * this.renderer.stave.staveGroup.layout.renderer.settings.scale | 0;
      break;
    default:
      this.width = 9 * (this._isGrace?0.7:1) * this.renderer.stave.staveGroup.layout.renderer.settings.scale | 0;
    }
...
alphatab.rendering.glyphs.NoteNumberGlyph = function(x,y,n,isGrace) {
  ...
  if(!n.isTieDestination) {
    if(n.isDead) this._noteString = "X"; else if(n.fret == null) this._noteString = "null"; else this._noteString = "" + n.fret;
...
alphatab.rendering.glyphs.NoteNumberGlyph.prototype = $extend(alphatab.rendering.Glyph.prototype,{
  ...
  ,calculateWidth: function() {
    this.width = Std["int"](this.renderer.stave.staveGroup.layout.renderer.canvas.measureText(this._noteString));
  }
  ,paint: function(cx,cy,canvas) {
...
alphatab.rendering.glyphs.RepeatCloseGlyph.prototype = $extend(alphatab.rendering.Glyph.prototype,{
  doLayout: function() {
    var base;
    if(this.renderer.isLast()) base = 11; else base = 13;
...
alphatab.rendering.glyphs.RestGlyph.prototype = $extend(alphatab.rendering.glyphs.SvgGlyph.prototype,{
  doLayout: function() {
    ...
    case 5:
      ...
      break;
    case 6:
      this.width = 14 * this.renderer.stave.staveGroup.layout.renderer.settings.scale | 0;
      break;
    }
  }
  ,canScale: function() {
...
alphatab.rendering.glyphs.ScoreBeatContainerGlyph.prototype = $extend(alphatab.rendering.glyphs.BeatContainerGlyph.prototype,{
  createTies: function(n) {
    if(n.isTieDestination && n.tieOrigin != null) {
      ...
      var tie1 = new alphatab.rendering.glyphs.ScoreTieGlyph(n.hammerPullOrigin,n,this);
      this.ties.push(tie1);
    } else if(n.slideType == alphatab.model.SlideType.Legato) {
      var tie2 = new alphatab.rendering.glyphs.ScoreTieGlyph(n,n.slideTarget,this);
      this.ties.push(tie2);
    }
...
alphatab.rendering.glyphs.ScoreBeatGlyph.prototype = $extend(alphatab.rendering.glyphs.BeatGlyphBase.prototype,{
    ...
    if(!this.container.beat.isEmpty) {
      if(!this.container.beat.isRest()) {
        ...
        if(this.container.beat.dots > 0) {
          this.addGlyph(new alphatab.rendering.glyphs.SpacingGlyph(0,0,5 * this.renderer.stave.staveGroup.layout.renderer.settings.scale | 0,false));
          var _g1 = 0;
          ...
          while(_g1 < _g2) {
            ...
            this.noteLoop((function(group) {
              return function(n1) {
                _g.createBeatDot(sr.getNoteLine(n1),2,group[0]);
              };
            })(group));
        ...
        var offset = 0;
        var dotOffset = 0;
        var _g3 = this.container.beat.duration;
        switch(_g3[1]) {
        case 0:
          line = 4;
          dotLine = 4;
        ...
        var sr1;
        sr1 = js.Boot.__cast(this.renderer , alphatab.rendering.ScoreBarRenderer);
        var y = sr1.getScoreY(line,offset);
        this.addGlyph(new alphatab.rendering.glyphs.RestGlyph(0,y,this.container.beat.duration));
        if(this.container.beat.dots > 0) {
          this.addGlyph(new alphatab.rendering.glyphs.SpacingGlyph(0,0,5 * this.renderer.stave.staveGroup.layout.renderer.settings.scale | 0,false));
          var _g11 = 0;
          var _g4 = this.container.beat.dots;
          while(_g11 < _g4) {
            var i1 = _g11++;
            var group1 = new alphatab.rendering.glyphs.GlyphGroup();
  ...
  ,createBeatDot: function(line,offset,group) {
    var sr;
    sr = js.Boot.__cast(this.renderer , alphatab.rendering.ScoreBarRenderer);
    group.addGlyph(new alphatab.rendering.glyphs.CircleGlyph(0,sr.getScoreY(line,offset + 2),1.5 * this.renderer.stave.staveGroup.layout.renderer.settings.scale));
  }
...
alphatab.rendering.glyphs.ScoreBeatPostNotesGlyph.prototype = $extend(alphatab.rendering.glyphs.BeatGlyphBase.prototype,{
  doLayout: function() {
    this.addGlyph(new alphatab.rendering.glyphs.SpacingGlyph(0,0,Std["int"](this.getBeatDurationWidth() * this.renderer.stave.staveGroup.layout.renderer.settings.scale)));
    alphatab.rendering.glyphs.BeatGlyphBase.prototype.doLayout.call(this);
  }
...
alphatab.rendering.glyphs.ScoreBrushGlyph.prototype = $extend(alphatab.rendering.Glyph.prototype,{
  ...
  ,paint: function(cx,cy,canvas) {
    ...
    var res = this.renderer.stave.staveGroup.layout.renderer.renderingResources;
    var startY = cy + this.y + Std["int"](scoreBarRenderer.getNoteY(this._beat.maxNote()) - lineSize / 2);
...
alphatab.rendering.glyphs.ScoreNoteChordGlyph.prototype = $extend(alphatab.rendering.Glyph.prototype,{
  ...
  ,doLayout: function() {
    ...
    if(this.beat.tremoloSpeed != null) {
      var direction = this.beamingHelper.getDirection();
      var offset;
      var baseNote;
      if(direction == alphatab.rendering.utils.BeamDirection.Up) baseNote = this.minNote; else baseNote = this.maxNote;
      var tremoloX;
      if(direction == alphatab.rendering.utils.BeamDirection.Up) tremoloX = displacedX; else tremoloX = 0;
      if(this.beat.tremoloSpeed != null) {
        var speed = this.beat.tremoloSpeed;
        switch(speed[1]) {
        case 5:
          if(direction == alphatab.rendering.utils.BeamDirection.Up) offset = -15; else offset = 10;
          break;
        case 4:
          if(direction == alphatab.rendering.utils.BeamDirection.Up) offset = -12; else offset = 10;
          break;
        case 3:
          if(direction == alphatab.rendering.utils.BeamDirection.Up) offset = -10; else offset = 10;
          break;
        default:
          if(direction == alphatab.rendering.utils.BeamDirection.Up) offset = -15; else offset = 15;
        }
      } else if(direction == alphatab.rendering.utils.BeamDirection.Up) offset = -15; else offset = 15;
...
alphatab.rendering.glyphs.TabBeatContainerGlyph.prototype = $extend(alphatab.rendering.glyphs.BeatContainerGlyph.prototype,{
  createTies: function(n) {
    if(n.isHammerPullDestination && n.hammerPullOrigin != null) {
      ...
      var tie1 = new alphatab.rendering.glyphs.TabTieGlyph(n,n.slideTarget,this);
      this.ties.push(tie1);
    }
    if(n.slideType != alphatab.model.SlideType.None) {
...
alphatab.rendering.glyphs.TabBeatGlyph.__interfaces__ = [alphatab.rendering.glyphs.ISupportsFinalize];
...
alphatab.rendering.glyphs.TabBeatGlyph.prototype = $extend(alphatab.rendering.glyphs.BeatGlyphBase.prototype,{
  ...
  ,finalizeGlyph: function(layout) {
    if(!this.container.beat.isRest()) this.noteNumbers.updateBeamingHelper(this.container.x + this.x);
  }
  ,applyGlyphSpacing: function(spacing) {
    alphatab.rendering.glyphs.BeatGlyphBase.prototype.applyGlyphSpacing.call(this,spacing);
    if(!this.container.beat.isRest()) this.noteNumbers.updateBeamingHelper(this.container.x + this.x);
...
alphatab.rendering.glyphs.TabBeatPostNotesGlyph.prototype = $extend(alphatab.rendering.glyphs.BeatGlyphBase.prototype,{
  ...
  ,createNoteGlyphs: function(n) {
    ...
    if(n.bendPoints.length > 1) {
      ...
      this.addGlyph(new alphatab.rendering.glyphs.BendGlyph(n,Std["int"](this.getBeatDurationWidth() * this.renderer.stave.staveGroup.layout.renderer.settings.scale),bendHeight));
    }
  }
...
alphatab.rendering.glyphs.TabBrushGlyph.prototype = $extend(alphatab.rendering.Glyph.prototype,{
  ...
  ,paint: function(cx,cy,canvas) {
    ...
    var res = this.renderer.stave.staveGroup.layout.renderer.renderingResources;
    var startY = cy + this.y + Std["int"](tabBarRenderer.getNoteY(this._beat.maxNote()) - res.tablatureFont.getSize() / 2);
...
alphatab.rendering.glyphs.TabNoteChordGlyph.prototype = $extend(alphatab.rendering.Glyph.prototype,{
  ...
  ,doLayout: function() {
    ...
    var effectY = Std["int"](this.getNoteY(this._minNote) + tabHeight / 2);
  ...
  ,updateBeamingHelper: function(cx) {
    if(!this.beamingHelper._beatLineXPositions.exists(this.beat.index)) this.beamingHelper.registerBeatLineX(this.beat,cx + this.x + this._centerX,cx + this.x + this._centerX);
  }
...
alphatab.rendering.glyphs.WhammyBarGlyph.prototype = $extend(alphatab.rendering.Glyph.prototype,{
  doLayout: function() {
    ...
    if(absMinY < 0) tabBarRenderer.registerOverflowTop(Std["int"](Math.abs(absMinY)));
    if(absMaxY > 0) tabBarRenderer.registerOverflowBottom(Std["int"](Math.abs(absMaxY)));
...
alphatab.rendering.glyphs.effects.TrillGlyph.prototype = $extend(alphatab.rendering.Glyph.prototype,{
  paint: function(cx,cy,canvas) {
    ...
    while(_g < loops) {
      ...
      glyph.paint(cx + this.x,cy + this.y + Std["int"](res.markerFont.getSize() / 2),canvas);
...
alphatab.rendering.staves.Stave.prototype = {
  ...
  ,finalizeStave: function(layout) {
    ...
    while(_g1 < _g) {
      ...
      this.height = Std["int"](Math.max(this.height,this.barRenderers[i].height));
...
alphatab.rendering.staves.StaveGroup.prototype = {
  ...
  ,addBars: function(tracks,barIndex) {
    ...
    if(!this._accoladeSpacingCalculated && this.index == 0) {
      ...
      while(_g < tracks.length) {
        var t = tracks[_g];
        ++_g;
        this.accoladeSpacing = Std["int"](Math.max(this.accoladeSpacing,canvas.measureText(t.shortName)));
      }
    ...
    var realWidth = 0;
    var _g4 = 0;
    var _g12 = this._allStaves;
    while(_g4 < _g12.length) {
      var s1 = _g12[_g4];
      ++_g4;
      s1.barRenderers[s1.barRenderers.length - 1].applySizes(maxSizes);
      if(s1.barRenderers[s1.barRenderers.length - 1].width > realWidth) realWidth = s1.barRenderers[s1.barRenderers.length - 1].width;
    }
  ...
  ,paint: function(cx,cy,canvas) {
    ...
    if(this.staves.length > 0) {
      ...
      while(_g2 < _g11.length) {
        var g = _g11[_g2];
        ++_g2;
        var firstStart1 = cy + this.y + g.firstStaveInAccolade.y + g.firstStaveInAccolade.staveTop + g.firstStaveInAccolade.topSpacing + g.firstStaveInAccolade.getTopOverflow();
        var lastEnd1 = cy + this.y + g.lastStaveInAccolade.y + g.lastStaveInAccolade.topSpacing + g.lastStaveInAccolade.getTopOverflow() + g.lastStaveInAccolade.staveBottom;
        ...
        if(this.index == 0) canvas.fillText(g.track.shortName,cx + this.x + 10 * this.layout.renderer.settings.scale,firstStart1);
  ...
  ,buildBoundingsLookup: function(lookup) {
    ...
    var _g = 0;
    var _g1 = this._firstStaveInAccolade.barRenderers;
    while(_g < _g1.length) {
      var b = _g1[_g];
      ++_g;
...
alphatab.rendering.utils.BeamBarType.__empty_constructs__ = [alphatab.rendering.utils.BeamBarType.Full,alphatab.rendering.utils.BeamBarType.PartLeft,alphatab.rendering.utils.BeamBarType.PartRight];
...
alphatab.rendering.utils.BeamingHelper.prototype = {
  ...
  ,getDirection: function() {
    var avg = Std["int"]((this.getValue(this.maxNote) + this.getValue(this.minNote)) / 2);
...
alphatab.rendering.utils.SvgPathParser.prototype = {
  ...
  ,nextToken: function() {
    ...
    if(!this.eof() || !skipChar) {
      if(c == null) token.b += "null"; else token.b += "" + c;
...
alphatab.Environment.renderEngines.set("html5",function(d1) {
  return new alphatab.platform.js.Html5Canvas(d1);
});
alphatab.Environment.renderEngines.set("svg",function(d2) {
...
alphatab.Environment.layoutEngines.set("page",function(r1) {
  return new alphatab.rendering.layout.PageViewLayout(r1);
});
alphatab.Environment.layoutEngines.set("horizontal",function(r2) {
...
alphatab.rendering.glyphs.BeatContainerGlyph.SizeTable = [82,43,30,22,18,14,14];
