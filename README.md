...
a cross platform music notation and guitar tablature rendering library

## Install

```bash
$ cortex install alphatab --save
```
...
Creates a new alphatab instance.
...
### alphatab.&lt;method-name&gt;(arguments)
